    ...
    public static List<Table> getTables() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String firstLowerCaseClassName = className.substring(0, 1).toLowerCase() + className.substring(1);
...
//        List<Column> itrip_hotel = TableHandler.getColumns("itrip_hotel");
//        for (Column column : itrip_hotel
//                ) {
